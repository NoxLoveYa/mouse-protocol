...
export const DEVICE_DRIVERS: readonly DeviceDriver[] = [
  ...
  { brand: "Sony", supports: (device) => DualSenseHidClient.isSupported(device), create: (device) => new DualSenseHidClient(device), score: () => 10 },
];
